        ...
        <div className={styles['main']}>
            ...
            <div className={styles['article-content-container']}>
                <div className={styles['content']}>
                    ...
                    <div className={styles['info-value']}>{article.testExplain}</div>
                </div>
                <div className={styles['double-content']}>
                    <div className={styles['content']}>
                        <label className={styles['content-label']}>입력 예시</label>
                        <div className={styles['info-value']}>{article.inputExample}</div>
                    </div>
                    <div className={styles['content']}>
                        <label className={styles['content-label']}>출력 예시</label>
                        <div className={styles['info-value']}>{article.outputExample}</div>
                    </div>
                </div>
                <div className={styles['content']}>
                    <label className={styles['content-label']}>해답 코드</label>
                    <SyntaxHighlighter className={styles['info-value']}
                ...
                <div className={styles['content']}>
                    ...
                    <div className={styles['info-value']}>{article.codeExplain}</div>
                </div>
                <div className={styles['content']}>
                    <label className={styles['content-label']}>알게 된 개념 정리</label>
                    <div className={styles['info-value']}>{article.concept}</div>
                </div>
            </div>
            <Footer/>
        </div>
